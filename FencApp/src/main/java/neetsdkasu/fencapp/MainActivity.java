...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.fencViewModel.exportResult.setListener(this, new ValueListener<Boolean>() {
            @Override
            public void onUpdate(Boolean result) {
                if (result) {
                    log.setText(R.string.log_message_dec_success);
                } else {
                    log.setText(R.string.log_message_unknown_error);
                }
                MainActivity.this.setUiEnabled(true);
            }
        });
    ...
    void beIdleByCanceled() {
        TextView log = findViewById(R.id.log_message);
        log.setText(R.string.log_message_canceled);
        setUiEnabled(true);
    }
    ...
    private final class ExportOrigFileCondacts extends ActivityResultManager.Condacts<String> {
        ...
        public void onOk(Intent data) {
            ...
            MainActivity.this.fencViewModel.export(uri);
        }
    }
