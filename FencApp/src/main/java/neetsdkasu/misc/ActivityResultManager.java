...
public final class ActivityResultManager {
    ...
    public static abstract class Condacts<T> implements ActivityResultManager.IntentCreator<T>,
    ...
    public static final class Launcher<T> {
        ...
        public boolean launch() { return launch(null); }

        public boolean launch(T arg) {
    ...
    public <T> ActivityResultManager.Launcher<T> register(ActivityResultManager.Condacts<T> condacts) {
        Flag flag = new Flag();
    ...
    public <T> boolean unregister(ActivityResultManager.Condacts<T> condacts) {
        if (condacts == null) {
            return false;
        }
